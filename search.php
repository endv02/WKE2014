...
?> 
    ...
    <?php if ( have_posts() ) : ?>
      ...
      if (( isset($options['category-num-article-fullwidth']))
		 ...
		 wke2014_post_teaser($options['category-teaser-titleup-halfwidth'],$options['category-teaser-datebox-halfwidth'],$options['category-teaser-dateline-halfwidth'],$options['category-teaser-maxlength-halfwidth'],$options['teaser-thumbnail_fallback'],$options['category-teaser-floating-halfwidth']);  
      }    
      ...
      <div class="columns">
        ...
        ?>     
             ...
             <?php else : ?>
                        ...
                        <p>
                            <?php _e("Es konnten keine Seiten oder Artikel gefunden werden, die zu der Sucheingabe passten. Bitte versuchen Sie es nochmal mit einer  anderen Suche.", 'wke2014'); ?>
                            
                        </p>
                        <?php get_search_form(); ?>
                        
                        <p>
                            <?php _e("Alternativ verwenden Sie einen der folgenden Links.", 'wke2014'); ?>
                                      
                        </p>
                        
                        <div class="widget">
                            <h3><?php _e("Archiv nach Monaten", 'wke2014'); ?></h3>                           
                            <?php wp_get_archives('type=monthly'); ?>               
                        </div>
                                                                        
                         <div  class="widget">
                            <h3><?php _e("Artikel nach Schlagworten", 'wke2014'); ?></h3>    
                            <div class="tagcloud">
                             <?php wp_tag_cloud(array('smallest'  => 12, 'largest'   => 28)); ?>
                             </div>
                        </div>
                        <div class="widget">
                        <h3><?php _e("&Uuml;bersicht aller Kategorien", 'wke2014'); ?></h3>
                        <ul>                            
